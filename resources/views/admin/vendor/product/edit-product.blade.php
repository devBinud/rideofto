    ...
    <div class="card">
        <div class="card-body px-4">
            ...
            <form method="post" action="{{ url('vendor/product?action=edit-product') }}" id="editProductForm"
                ...
                {{-- <input type="hidden" name="productTypeId" value="{{ $productdata->product_type_id }}"> --}}
                <div class="row mt-4">
                    <div class="col-md-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="attributeId[]" class="form-select" id="">
                                @foreach ($attribute as $a)
                                    <option value="{{ $a->id }}" @if ($details->product_attr_id == $a->id) selected @endif>
                                        {{ $a->product_attr_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="unitId[]" class="form-select" id="">
                                ...
                                @foreach ($unit as $u)
                                    <option value="{{ $u->id }}" @if ($details->attribute_value_unit_id == $u->id) selected @endif>
                                        {{ $u->unit }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                @endforeach
                <div class="row mt-2">
                    <input type="hidden" name="prev_product_details[]" value="">
                    <div class="col-md-4">
                        <label for="" class="form-label required">Attribute</label>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" name="planUnit[]" id="">
                                <option value="{{ $data->pricing_plan_unit }}" selected>{{ $data->pricing_plan_unit }}
                                </option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="addCharge[]" class="form-control"
                                placeholder="Enter additional charge" value="{{ $data->addn_charge }}">
                        </div>
                    </div>
                @endforeach

                <div class="row mt-3">
                    <input type="hidden" name="prev_product_price[]" value="">
                    <div class="col-md-3">
                        <label for="" class="form-label required">Plan Unit</label>
                        <select class="form-select" name="planUnit[]" id="">
                            <option selected disabled>Select Plan Unit...</option>
                            <option value="hour">Hour</option>
                            <option value="day">Day</option>
                            <option value="week">Week</option>
                            <option value="month">Month</option>
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="row d-none mt-2" id="isHomeDeliveryDiv">
                            <div class="col-md-4 py-1">
                                <label for="aadhar" class="form-label">Max Distance (km) </label>
                                <input type="text" class="form-control" name="maxdistance"
                                    placeholder="Enter max distance  in kelo meter">
                            </div>
                            <div class="col-md-4 py-1">
                                <label for="aadhar" class="form-label">Delivery Charge/km </label>
                                <input type="text" class="form-control" name="delivery_charge"
