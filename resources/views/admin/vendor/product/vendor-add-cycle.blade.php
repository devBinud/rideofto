    ...
    <div class="card">
        <div class="card-body row">
            ...
            <div class="col-md-12 mt-3" style="border:1px solid #dee4e7;border-radius:10px">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('admin/vendor?action=vendor-add-item&item=Cycle') }}" method="POST" id="addNewCycleForm"
                            ...
                            <div class="float-end mt-3">
                                <button class="btn btn-primary mt-2" id="btnSubmit" type="submit"><i class="fas fa-paper-plane"></i> Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (!data.success) {
                            ...
                            alert(data.message);
                            // location.reload();
                            window.location.replace("{!! url('admin/vendor?action=vendor-item-lists&filter=Cycle&id=') !!}"+"{{ $id }}");
                        }
                    },
                    complete: function() {
